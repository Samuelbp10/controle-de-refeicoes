...
// Criei esse Input base estilizado para os campos do formulário ficarem exatamente com a borda e cor do Figma
...
// Botões de seleção de dieta (Sim/Não)
...
export const BotaoDieta = styled(TouchableOpacity)<BotaoDietaProps>`
  ...
  /* Lógica para mudar a cor de fundo e a borda se o botão estiver selecionado */
...
// Container para empurrar o botão de submeter lá pro final da tela
